...
Primero cambie el nombre del scanner de "x" a "input".
Le cambie el nombre a la variable que pide el nombre del primer estudiante, de "a" a "PrimerNombreEstudiante".
